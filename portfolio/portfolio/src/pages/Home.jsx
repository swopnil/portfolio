  ...
  const projects = [
    {
      ...
      description: "I developed NoteNinja, a currency recognition application, inspired by my mother's daily struggles with partial vision. Watching her difficulty in identifying bills and having to rely on others for help deeply affected me, especially after I left for college. This personal connection drove me to leverage my computer science background to create a practical solution. Using advanced CNN models including ResNet50, VGG16, and Inception-v3, I built a robust system that could accurately identify currency bills in real-time. To ensure the app would work reliably in real-world conditions – like the varying lighting in stores or the different ways my mom might hold her phone – I created a diverse dataset of over 50,000 currency images from 25 countries, captured under various conditions. The iOS application I developed features voice feedback in multiple languages, achieving 90% accuracy in currency detection. Through careful optimization and image augmentation techniques, I reduced overfitting by 40%, ensuring the app would be dependable for daily use. What started as a personal mission to help my mother has evolved into a tool that empowers visually impaired individuals worldwide to manage their finances independently and confidently.",
