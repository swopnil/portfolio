...
Building AI solutions that make a real difference. Explore my projects and journey in machine learning and software development.
    ...
    <motion.div
      ...
      className="flex justify-center gap-2 sm:gap-3 md:gap-4 flex-wrap relative z-50"  // Added z-50
    >
      <a 
      ...
      <a 
        ...
        className="flex items-center gap-2 bg-white text-blue-600 px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-blue-50 transition-colors cursor-pointer z-50 text-sm sm:text-base"
      >
        <Download size={20} />
        Resume
      </a>
